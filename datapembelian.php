...
<?php
include "koneksi.php";
$orderan=1; // Ganti dengan ID mobil yang sesuai
...
<div class="row table bingkai">
    <div class="col-lg-12" align="justify">
        <h1 class="page-header text-center">DAFTAR PEMESANAN</h1>
...
while ($tampil = mysqli_fetch_array($ambildata)){
    echo "
        <tr>
        <td>$no</td>
        <td>$tampil[orderan]</td>
        <td>$tampil[nama_depan]</td>
        <td>$tampil[nama_belakang]</td>
        ...
        <td><button class='hapus-btn' data-id='{$tampil['orderan']}'>Hapus</button></td>
        <tr>";
