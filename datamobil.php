...
while ($tampil = mysqli_fetch_array($ambildata)){
    echo "
        <tr>
        <td>$no</td>
        <td>$tampil[merek_mobil]</td>
        <td>$tampil[harga]</td>
        <td>$tampil[tipe_kendaraan]</td>
        <td>$tampil[tipe_mesin]</td>
        <td>$tampil[kapasitas_mesin]</td>
        <td>$tampil[bahan_bakar]</td>
        <td>$tampil[tenaga_mesin]</td>
        <td>$tampil[jenis_transmisi]</td>
        <td>$tampil[jenis_turbo]</td>
        
        <td><img class='card-img-top' src='images/{$tampil['gambar_kendaraan']}'></td>
        <td><button class='hapus-btn' data-id='{$tampil['id_mobil']}'>Hapus</button></td>
